...
function tambah($data)
{
    ...
    $query = "INSERT INTO mahasiswa 
              (nama, email, jurusan, universitas, idbuku, jumlahalaman, penerbit, penulis, gambar) 
              VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";

    $stmt = mysqli_prepare($conn, $query);
    mysqli_stmt_bind_param($stmt, "sssssssss", $nama, $email, $jurusan, $universitas, $idbuku, $jumlahalaman, $penerbit, $penulis, $gambar);
